...
import Link from 'next/link'; // برای Next.js
// اگر از React Router استفاده می‌کنید، از این خط استفاده کنید
// import { Link } from 'react-router-dom'; // برای React Router
// Import Lucide icons - if you don't have lucide-react installed
